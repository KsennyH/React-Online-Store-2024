...
export default function SingleProductPage () {
  ...
  const {product} = useAppSelector((state:RootState) => state.singleProduct);
  ...
  return (
                    ...
                    <div className="container">
                        <div className="card-block__wrapper">
                            ...
                            <div className="card-block__content">
                                <h2 className="card-block__title">Wels Impulse 250сс</h2>
                                <span className="card-block__article">Артикул: 26894</span>
                                <div className="card-block__color color-block">
                                    <span className="color-block__label">Цвет:</span>
                                    <ul className="color-block__list">
                                        <li className="color-block__item">
                                            <button className="color-block__btn js-color-btn" data-color="#white">
                                                <span className="color-block__btn-tab color-block__btn-tab--white"></span>
                                            </button>
                                        </li>
                                        <li className="color-block__item">
                                            <button className="color-block__btn js-color-btn" data-color="#red">
                                                <span className="color-block__btn-tab color-block__btn-tab--red"></span>
                                            </button>
                                        </li>
                                        <li className="color-block__item">
                                            <button className="color-block__btn js-color-btn" data-color="#black">
                                                <span className="color-block__btn-tab color-block__btn-tab--black"></span>
                                            </button>
                                        </li>
                                    </ul>
                                </div>
                                <span className="card-block__price">150 000 руб.</span>
                                <div className="card-block__buttons">
                                    <button className="card-block__btn btn-busket">
                                        <ShoppingCart color="#ffffff" />
                                        <span className="btn-busket__text">В корзину</span>
                                    </button>
                                    <button className="card-block__link link">Купить в 1 клик</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    //         <div className={styles.singlePage__images}>
    //             <div className={styles.singlePage__image}>
    //               <img src={product.img} alt={product.title} loading="lazy" />
    //             </div>
    //         </div>
    //         <div className={styles.singlePage__content}>
    //           <h2 className={styles.singlePage__title}>{product.title}</h2>
    //           <span className={styles.singlePage__article}>Артикул: {product.article}</span>
    //           <div className={styles.singlePage__color}>
    //               <span className={styles.singlePage__label}>Цвет:</span>
    ...
    //               </ul>
    //           </div>
    //           <span className={styles.singlePage__price}>{product.price} руб.</span>
